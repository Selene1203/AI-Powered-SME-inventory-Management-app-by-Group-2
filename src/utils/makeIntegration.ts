...
import webhookConfig from '../config/makeWebhooks.json\' assert { type: 'json' };
import scenarioConfig from '../config/makeScenarios.json\' assert { type: 'json' };
import templateConfig from '../config/makeTemplates.json\' assert { type: 'json' };
